...
### **숭실대학교 IT지원위원회**
- **Frontend Web Leader** | **[2024.09 ~ 2025.07]**
...
| 프로젝트명 | 설명 | 참여 기간 | 역할 |
|------------|------|------|------|
| [숭실대 총학생회 홈페이지 리뉴얼](https://stu.ssu.ac.kr) ([GitHub](https://github.com/jongse7/homepage-frontend)) | 숭실대학교 총학생회 홈페이지 리뉴얼 프로젝트. php -> react + typescript | 2024.07 ~ 2025.07 | 프론트엔드 개발, 성능 최적화, CI/CD 구성 |
| [Riv](https://www.riv-discord.online) ([GitHub](https://github.com/OpenRiv/riv-frontend)) | Discord 기반 회의 기록 및 음성 분석 서비스. | 2024.09 ~ 2024.12 | 프론트엔드 개발, OAuth 연동, 상태관리 |
| [Docshunt Ai](https://docshunt.ai/) | 사업계획서 전문 AI 서비스 | 2025.08 ~ 2026.02 | v 2.0.0 ~ ^3.0.0 기능 개발 및 유지보수 (tanstack/query, blocknote, react-markdown, i18n ...) |

## Education 
- **숭실대학교 글로벌미디어학부 - [2020.03 ~ 2026.02]**
